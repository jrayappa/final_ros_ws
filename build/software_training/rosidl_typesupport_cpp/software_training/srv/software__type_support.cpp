...
static const _Software_Request_type_support_symbol_names_t _Software_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, software_training, srv, Software_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, software_training, srv, Software_Request)),
  }
};
...
{
  return &::software_training::srv::rosidl_typesupport_cpp::Software_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, software_training, srv, Software_Request)() {
  return get_message_type_support_handle<software_training::srv::Software_Request>();
}
...
static const _Software_Response_type_support_symbol_names_t _Software_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, software_training, srv, Software_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, software_training, srv, Software_Response)),
  }
};
...
{
  return &::software_training::srv::rosidl_typesupport_cpp::Software_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, software_training, srv, Software_Response)() {
  return get_message_type_support_handle<software_training::srv::Software_Response>();
}
...
static const _Software_type_support_symbol_names_t _Software_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, software_training, srv, Software)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, software_training, srv, Software)),
  }
};
...
{
  return &::software_training::srv::rosidl_typesupport_cpp::Software_service_type_support_handle;
}
