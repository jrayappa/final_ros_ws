...
#define NODE_MAIN_LOGGER_NAME "moving_action_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libturtle_action_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<composition::moving_turtle_action_server>";
